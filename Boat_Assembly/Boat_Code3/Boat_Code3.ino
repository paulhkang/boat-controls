...
//Prototypes
void StopMoving(int ctr1, int ctr2);             //designed specifically for locking drive motors
void MoveMotor(int dir, int pwm, int duty);    //designed specifically for drive motors
void getPos();
...
void loop() {
  ...
  fL_st=constrain((-floor(256*k_theta*(d_theta/u_max))),-18,18);
  //Right Motor Control Law
  fR_st=constrain((floor(256*k_theta*(d_theta/u_max))),-18,18);
...
//////////////////////////////////////////////////////////////  
  ...
  MoveMotor(L0,LPWM,(fL_pos+fL_st));//Left Motor
  MoveMotor(R0,RPWM,(fR_pos+fR_st));//Right Motor
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Motor Functions
void StopMoving(int ctr1, int ctr2){//Dead Stop
  digitalWrite(ctr1,LOW);
  digitalWrite(ctr2,LOW);  
}

void MoveMotor(int dir, int pwm, int duty){
...
void getPos() {
  ...
  while(Serial.available() and i<5){ 
    pos[i++]= Serial.parseFloat();//get coordinate array x y
  }
}
